...
The Dataset is downloaded from Kaggle [^1], and originally sourced from the Spotify Web API.

[^1]: [Pink Floyd Audio Features](https://www.kaggle.com/datasets/thebumpkin/pink-floyd-all-the-tracks-with-spotify-data/data)

## Echoes of Change

Music evolves as a reflection of the forces shaping its creators. Pink Floyd is a prime example of how external and internal changes influence artistic direction. Syd Barrett, the band’s original creative mastermind, is widely credited with shaping their early identity as a psychedelic rock band. However, his departure in 1968 due to mental health struggles marks a profound turning point in their history [^2].

[^2]: [Pink Floyd Wikipedia](https://en.wikipedia.org/wiki/Pink_Floyd)

In this project, I investigate whether this transformation can be quantified through measurable changes in their music. Specifically, I analyze the energy levels of their songs, a Spotify-defined metric that captures the intensity and activity [^3] of a track. Energy is a useful proxy for several other musical attributes, such as mood, tempo, and instrumental variation, making it an ideal choice for tracing Pink Floyd’s evolution.

[^3]: [Spotify Web-API Docs](https://developer.spotify.com/documentation/web-api/reference/get-audio-features)
...
To understand the band’s evolution, I calculate the average energy levels of their albums. This is important because Pink Floyd is known for their 
...
These patterns in energy levels provide a compelling narrative of Pink Floyd’s evolution, but to rigorously evaluate the differences between the Pre-Barrett and Post-Barrett eras, we must turn to statistical significance testing.
...
The results show a 16% reduction in average energy levels after Barrett’s departure. While this difference is visually apparent, it could still be due to chance. To validate this finding, I conducted a two-sample t-test to compare the energy levels across the two eras.
...
The t-statistic of 3.503, a measure of how much the observed difference deviates from the expectation under the null hypothesis, indicates a strong separation between the energy levels of the two eras. In real terms, this reflects a marked departure from the spontaneous, high-energy sounds to the more introspective and deliberate compositions. The confidence interval, ranging from 0.0699 to 0.2587, provides a plausible range for the true difference in mean energy levels. Even the lower bound of this interval suggests a meaningful reduction, reinforcing that the decline in energy is a consistent trend.

Additionaly, the 16% difference between the average energy of the Pre-Barrett era (0.471) and the Post-Barrett era (0.307) highlights the band's shift. This analysis highlights not only the statistical significance of the change but also its artistic implications: Pink Floyd’s evolution from Barrett’s raw, exploratory style to a more structured, thematic approach.

However, significance does not imply causation. While Barrett’s departure aligns with this shift, it is essential to recognize other factors that may have contributed. These could include the natural evolution of progressive rock, the band’s responses to societal changes, or shifts in their creative direction. This highlights the importance of interpreting statistical findings within the broader context of Pink Floyd’s artistic journey.
...
While the data confirms a sharp, and significant reduction in energy, this transformation cannot be solely attributed to Barrett’s absence. External factors, including the maturation of progressive rock as a genre and the band’s artistic growth, undoubtedly influenced this evolution. Still, Barrett’s departure served as a catalyst, prompting Pink Floyd to adapt and innovate in response to this pivotal moment.
